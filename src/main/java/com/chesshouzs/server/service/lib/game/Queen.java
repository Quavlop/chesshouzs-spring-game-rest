...
public class Queen extends Character{
    ...
    public Queen(String color, PositionDto position){
    ...
    public Boolean isValidMove(PositionDto oldPosition, char[][] oldState, char[][] newState){
        return MovementUsecase.straightMovementValidator(oldPosition, this.position, oldState) || MovementUsecase.diagonalMovementValidator(oldPosition, this.position, oldState);    
    }
