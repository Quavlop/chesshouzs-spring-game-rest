...
public class EvolvedPawn extends Character{
    
    public EvolvedPawn(String color){
        super(color);
    }    

    public EvolvedPawn(String color, PositionDto position){
    ...
    public Boolean isValidMove(PositionDto oldPosition, char[][] oldState, char[][] newState){
        return MovementUsecase.kingMovementValidator(oldPosition, this.position, oldState);
    }
    ...
    public Boolean isBlockingThreat(Character attacker){
        return true;
    }
    
    public Boolean isEliminatingThreat(Character attacker){
        return false;
    }
